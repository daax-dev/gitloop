...
## Project
Name: gitloop
Purpose: Local, git-only inner-loop tool — AI coding models/tools hand work off event-driven and deterministically via native git primitives (tags, worktrees) as the single source of truth. No shared DB, no orchestration service, no CI/CD. Pure TypeScript. See `OBJECTIVE.md`.
